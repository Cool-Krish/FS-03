...
const kl = document.querySelector(".input-msg");
kl.addEventListener("keyup", count)

function count(){
  let msgEle = document.querySelector(".input-msg");
    let msg = msgEle.value;
    const kk  = document.querySelector(".count-char")
    let total=msg.split(" ").length;
    kk.innerText ="Current characters:"+msg.length+" and current words:"+total ;
}
